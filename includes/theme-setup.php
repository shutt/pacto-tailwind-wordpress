...
function theme_load_assets()
{
    if (is_page('personalizar')) {
        wp_enqueue_script('app-personalizados', get_stylesheet_directory_uri() . '/assets/personalizados/js/main.aca89383.js', array(), null, true);
        wp_enqueue_style('style-personalizados', get_stylesheet_directory_uri() . '/assets/personalizados/css/main.bec58af1.css', array(), null, '');
    }
    wp_enqueue_style('swiper_css', get_theme_file_uri('/assets/css/swiper-bundle.min.css'), [], '20.0');
    wp_enqueue_style('thememaincss', get_theme_file_uri('/build/index.css'), [], '21.9');

...
function theme_load_assets()
{
    if (is_page("personalizar")) {
        wp_enqueue_script(
            ...
            get_stylesheet_directory_uri() .
                "/assets/personalizados/js/main.d4096c74.js",
            [],
            null,
            true
        );
        wp_enqueue_style(
            ...
            get_stylesheet_directory_uri() .
                "/assets/personalizados/css/main.e3ed993d.css",
            [],
            null,
            ""
        );
    ...
    wp_enqueue_style(
        "google-fonts",
        "https://fonts.googleapis.com/css2?family=EB+Garamond&family=Roboto+Condensed:wght@300;400;700&display=swap",
        false
    );
    wp_enqueue_script(
        "thememainjs",
    ...
    wp_enqueue_script(
        "acordeaojs",
        get_theme_file_uri("/assets/js/acordeao.js"),
        [],
        "1.0",
        true
    );
